...
# NOTE: This stack is intentionally reusing the existing AWS-managed role
#       AmazonEKSAutoClusterRole instead of creating a new cluster service role.
#       The old role-creation logic has been left commented below as a reference.
# ---------------------------------------------------------------------------
...
# # ---------------------------
# # Legacy role creation logic retained for reference only.
# # This is intentionally disabled because the role already exists in AWS.
# # ---------------------------
...
# NOTE: This stack is intentionally reusing the existing AWS-managed role
#       AmazonEKSAutoNodeRole instead of creating a new node instance role.
#       The old role-creation logic has been left commented below as a reference.
# ---------------------------------------------------------------------------
